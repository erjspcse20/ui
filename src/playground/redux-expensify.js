...
// SORT_BY_DATE
const shortbydate = (date = undefined) => ({
  type: 'SHORT_BY_DATE',
  date
});
// SORT_BY_AMOUNT
const shortbyamount = (amount) => ({
...
store.subscribe(() => {
 ...
 const expenseThree = store.dispatch(addExpense({ description: 'mango', amount: 1000, createdAt: 1000 }));
...
//store.dispatch(shortbydate(125));
